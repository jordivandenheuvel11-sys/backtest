...
# The upstream project imported the long-abandoned "fbprophet" package,
# which fails to install on modern Python (its pystan dependency doesn't
# build). "prophet" is the actively maintained successor with the same API
# (Facebook/Meta renamed the project in late 2020) - swap this back to
# `import fbprophet` only if you specifically need the legacy package.
